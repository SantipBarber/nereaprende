export const content = [
  ...
  ## Conocemos el clima
  El clima es el conjunto de condiciones atmosféricas que se dan en un lugar y en un momento determinado.
 ...
 Para conocer los climas hay que saber cómo son y cómo se distribuyen las temperaturas y las precipitaciones en cada estación del año.
  ...
  ## Las temperaturas
  Nos indican si hace calor o frío.
  Se miden con el **termómetro** y se 
  expresan en grados **Celsius** (°C).


  ## Las precipitaciones
  Son la cantidad de agua que se 
  recojecada día.
  Pueden ser de lluvia, de nieve o de granizo.
  Se miden con el **pluviómetro**.

  # ¿Por qué hay climas diferentes?  
  En la Tierra hay climas muy diferentes, con temperaturas y precipitaciones muy disparates a lo largo de los año.


 Estas diferenciasestan producidas por varios factores:
