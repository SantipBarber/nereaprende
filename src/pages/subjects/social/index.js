...
import { topics } from '../../../content/social/4/topic-1/topics';
import { questions } from '../../../content/social/4/topic-1/questions';
...
const TopicPage = () => {
  ...
  const title = topicInfo?.name || 'La Tierra y el Sistema Solar';
